...
def send_welcome_email(user_email, username):
    subject = "Welcome to ITEA 🛋️"
    message = f"""🛋️ Welcome {username}!

Thank you for joining ITEA, your destination for elegant and timeless furniture.

We're thrilled to have you with us! ✨

Enjoy exploring our carefully crafted pieces. 💫

With love,
ITEA Team
"""
    from_email = 'itea69776@gmail.com'
...
class CustomLoginView(LoginView):
    ...
    def get_success_url(self):
        ...
        if user.user_type in ['admin', 'seller']:
